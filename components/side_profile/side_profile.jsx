...
const side_profile = () => {
  return (
    <Wrapper>
        <Image src="/assets/avatar.jpg" width={100} height={100} className='w-full rounded-full' alt="profile" />
        <p className='text-lg font-extrabold pt-6 pb-1 text-gray-700'>Haziq Ali</p>
        <p className='text-sm text-bold text-blue-600'>@haziq-bangash</p>
        <p className='text-sm text-gray-600 py-3'>Web Developer | UI/UX Designer | Technical Writer | Community Builder | Web3 Enthusiast</p>
        ...
        <div id="externalLinks" className='text-gray-700 py-6'>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
            ...
            <span className=''>haziqbangash</span>
          </div>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
            ...
            <span className=''>haziq-ali-16bb791bb</span>
          </div>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
            ...
            <span className=''>haziqali516@gmail.com</span>
          </div>
        </div>
        <div id="githubInfo" className='text-gray-700 pb-6'>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
              <span className='text-lg text-bold me-2'>42</span>
              <span className=''>Repos</span>
          </div>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
              <span className='text-lg text-bold me-2'>1.8K</span>
              <span className=''>Followers</span>
          </div>
          <div className="link pb-2 flex items-center hover:text-blue-600 ease-in-out duration-300 cursor-pointer underline-offset-1 hover:underline">
              <span className='text-lg text-bold me-2'>24</span>
